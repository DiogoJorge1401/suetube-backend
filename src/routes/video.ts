...
videoRouter.get(
  '/trend', trendVideoController.handle
)
videoRouter.get(
  '/tags/:tags', tagsVideoController.handle
)
videoRouter.get(
  '/search/:title', searchVideoController.handle
)
videoRouter.get(
  '/random', randomVideoController.handle
)
videoRouter.get(
  '/subs', verifyToken, subsVideoController.handle
)
videoRouter.get(
  '/find/:id', getVideoController.handle
)
videoRouter.put(
  '/:id', verifyToken, updateVideoController.handle
)
videoRouter.put(
  '/view/:id', addViewVideoController.handle
)
videoRouter.delete(
  '/:id', verifyToken, deleteVideoController.handle
)
videoRouter.post(
  '/', verifyToken, addVideoController.handle
)
